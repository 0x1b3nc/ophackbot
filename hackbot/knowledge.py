...
CLASS_ROUTES: dict[str, tuple[str, ...]] = {
    "idor": ("web-vulns/idor-bac.md", "extreme/authz-elite.md"),
    "bola": ("web-vulns/idor-bac.md", "extreme/authz-elite.md"),
    "bac": ("web-vulns/idor-bac.md", "extreme/authz-elite.md"),
    "bfla": ("web-vulns/idor-bac.md", "extreme/authz-elite.md"),
    "authz": ("web-vulns/idor-bac.md", "extreme/authz-elite.md"),
    "access-control": ("web-vulns/idor-bac.md", "extreme/authz-elite.md"),
    "graphql": (
        "api-security/graphql-smuggling-cache.md",
        "web-vulns/idor-bac.md",
        "extreme/authz-elite.md",
    ),
    "oauth": ("web-vulns/auth-session.md", "extreme/jwt-saml-oidc.md"),
    "oidc": ("web-vulns/auth-session.md", "extreme/jwt-saml-oidc.md"),
    "jwt": ("web-vulns/auth-session.md", "extreme/jwt-saml-oidc.md"),
    ...
    "ssrf": ("web-vulns/ssrf.md", "extreme/ssrf-elite.md"),
    ...
    "race": ("web-vulns/race-conditions.md", "extreme/race-toctou.md"),
    ...
    "xss": ("web-vulns/client-side.md", "extreme/xss-dom-elite.md"),
    "dom-xss": ("extreme/xss-dom-elite.md", "web-vulns/client-side.md"),
    "prototype-pollution": ("web-vulns/client-side.md", "extreme/xss-dom-elite.md"),
    "postmessage": ("web-vulns/client-side.md", "extreme/xss-dom-elite.md"),
    "smuggling": (
        "api-security/smuggling-cache.md",
        "extreme/smuggle-desync-detect.md",
    ),
    "cache": (
        "api-security/smuggling-cache.md",
        "extreme/cache-poison-deception.md",
    ),
    "business-logic": ("extreme/business-logic-elite.md",),
    "business_logic": ("extreme/business-logic-elite.md",),
    "saml": ("extreme/jwt-saml-oidc.md", "web-vulns/auth-session.md"),
    "desync": ("extreme/smuggle-desync-detect.md",),
    "cache-poison": ("extreme/cache-poison-deception.md",),
    "chain": ("extreme/attack-chaining-bb.md",),
    "prohibited": ("extreme/prohibited-identify-stop.md",),
    "extreme": (
        "extreme/authz-elite.md",
        "extreme/business-logic-elite.md",
        "extreme/xss-dom-elite.md",
        "extreme/ssrf-elite.md",
    ),
